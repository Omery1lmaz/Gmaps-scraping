...
import { ArrowRight, Play, MessageCircle, MapPin, Sparkles, Bot, Globe, Terminal, Brain } from 'lucide-react'
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-6 space-y-8 text-left">
            ...
            <motion.h1
              ...
              className="text-lg sm:text-xl md:text-2xl font-bold text-white leading-tight tracking-tight"
            >
              {t.title}{' '}
            ...
            >
              {trustMetrics.map((m, idx) => (
                <div key={idx}>
                  <div className="text-lg sm:text-xl font-bold text-white">{m.val}</div>
