      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10">
        ...
        >
          ...
          <p className="text-base sm:text-lg text-slate-300 max-w-xl mx-auto mb-10 leading-relaxed font-medium">
            {language === 'tr' 
              ? "Geri dönüş oranlarını ikiye katlamak için LeadFlow AI kullanan 1000'den fazla ajans sahibine, pazarlamacıya ve yerel sosyal yardım uzmanına katılın."
              : "Join 1,000+ agency owners, marketers, and local outreach specialists using LeadFlow AI to double response rates."}
          </p>
