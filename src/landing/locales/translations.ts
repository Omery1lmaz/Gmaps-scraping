export const translations = {
  en: {
    ...
    solution: {
      ...
      desc: 'LeadFlow AI unifies lead extraction, AI copywriting, and WhatsApp outreach in a single browser-native command center.',
      headers: ['Capability', 'Manual Scraping', 'LeadFlow AI'],
      items: [
      ...
      items: [
        {
          ...
          a: 'No. LeadFlow AI runs directly inside your browser window through WhatsApp Web, meaning you do not need expensive Meta API keys or pre-approved templates.'
        },
        {
    ...
    finalCta: {
      ...
      desc: 'Get access to LeadFlow AI today. Download the Chrome Extension and start getting WhatsApp clients in minutes.',
  ...
  tr: {
    ...
    solution: {
      ...
      desc: 'LeadFlow AI, veri çekmeyi, yapay zeka içerik yazımını ve WhatsApp mesaj gönderimini tek bir tarayıcı tabanlı panelde birleştirir.',
      headers: ['Yetenek', 'Manuel Tarama', 'LeadFlow AI'],
      items: [
    ...
    testimonials: {
      ...
      titleHighlight: 'LeadFlow AI Yorumları',
      ...
      items: [
        {
          ...
          a: 'Hayır. LeadFlow AI doğrudan tarayıcınızda WhatsApp Web üzerinden çalışır; bu da pahalı Meta API anahtarlarına veya onaylı şablonlara ihtiyacınız olmadığı anlamına gelir.'
        },
        {
    ...
    finalCta: {
      ...
      desc: 'LeadFlow AI\'a bugün erişin. Chrome Eklentisini indirin ve dakikalar içinde WhatsApp üzerinden yeni müşteriler kazanmaya başlayın.',
